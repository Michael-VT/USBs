...
Click HEX → copy to clipboard"""
    ...
    def run_range(self) -> None:
        ...
        # Clear log and start sequence
        self.clear()
        self.line_counter = 0

        # Create temporary commands list for range execution
        # but keep seq_current indexing to match UI expectations if needed
        # Actually we can just start sequence at start and set a seq_end property
